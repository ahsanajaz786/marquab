$.fn.themeswitcher = function (settings) {
    var options = jQuery.extend({
        ...
        imgPrefix: "http://static.jquery.com/ui/themeroller/images/themeGallery/theme_90_",imgSuffix: ".png", imageLocation: "/javascripts/jquery/themeswitcher/",
        themes: {},
        useCookie: true
    }, settings);
    ...
    if (options.useStandard)
        $.extend(options.themes, {
            ...
            'humanity': {},
            'le-frog': {},
            'mint-choc': { icon: options.imgPrefix + "mint_choco" + options.imgSuffix, css: options.cssPrefix + "mint-choco" + options.cssSuffix },
            'overcast': {},
            'pepper-grinder': {},
            'redmond': { icon: "windoze" },
            'smoothness': {},
            'south-street': {},
            'start': { icon: 'start_menu' },
            'sunny': {},
            'swanky-purse': {},
            'trontastic': {},
            'ui-darkness': { icon: options.imgPrefix + 'ui_dark' + options.imgSuffix, css: options.cssPrefix + 'dark' + options.cssSuffix },
            'ui-lightness': { icon: options.imgPrefix + "ui_light" + options.imgSuffix, css: options.cssPrefix + "ui-light" + options.cssSuffix }
        });
    var theme_ul = "";
    ...
    switcherpane.find('a').click(function () {
        ...
        if (options.useCookie) $.cookie(options.cookieName, themeName, options);
        options.onSelect();
